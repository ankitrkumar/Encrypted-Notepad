...
public class NoteEditEnc extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
	  ...
	  @Override
		...
		public boolean onCreateOptionsMenu(Menu menu) {
			...
			getMenuInflater().inflate(R.menu.noteeditenc_menu, menu);
			return true;		
		}
		...
		public boolean onOptionsItemSelected(MenuItem item) {
		    ...
		    case R.id.menu_about:
		        ...
		        AlertDialog.Builder dialog = new AlertDialog.Builder(NoteEditEnc.this);
